...
public class KangaCape extends Base {
    private final ModelPlayer mainModel;

    public KangaCape(ModelPlayer mainModel) {
    ...
    public void render(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        //if
            ...
            Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("kangaClient/cosmetics/testcape1.png"));
